...
1. After you export the `student` table by submitting a ticket in the ODC console, click **<UI-TERM key="odc.components.SensitiveRule.View">View</UI-TERM>** in the **<UI-TERM key="odc.Secure.Approval.Operation">Actions</UI-TERM>** column of the export task in the export task list.[](../600.import-and-export/200.export-data.md)
