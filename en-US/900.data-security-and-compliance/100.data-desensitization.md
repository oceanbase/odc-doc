...
1. Log on to the ODC console as the project administrator and choose **<UI-TERM key="odc.page.Secure.SafetySpecifications">Security Specifications</UI-TERM>** > **<UI-TERM key="odc.components.SensitiveColumn.DesensitizationAlgorithm">Masking Algorithm</UI-TERM>** to view the built-in desensitization algorithms and test the desensitization effect.

2. Log on to the ODC console as the project administrator and choose **<UI-TERM>Projects</UI-TERM>** > **<UI-TERM>Sensitive Columns</UI-TERM>**. You can click **<UI-TERM key="odc.SensitiveColumn.components.FormSensitiveColumnDrawer.ManuallyAddSensitiveColumns">Add Sensitive Column</UI-TERM>** and select **<UI-TERM key="odc.components.SensitiveColumn.ManuallyAdd">Add Manually</UI-TERM>** or **<UI-TERM key="odc.components.SensitiveColumn.ScanAdd">Scan to Add</UI-TERM>**. To select **<UI-TERM key="odc.components.SensitiveColumn.ScanAdd">Scan to Add</UI-TERM>**, make sure that identification rules have been created.
