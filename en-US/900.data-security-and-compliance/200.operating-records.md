...
2. View the basic information displayed in the operation record list.
   ...
   | Execution Result | The execution result. Valid values: **<UI-TERM key="odc.components.SQLResultSet.SuccessfulExecution">Succeeded</UI-TERM>** and **<UI-TERM key="odc.component.RecordPopover.components.Failed">Failed</UI-TERM>**.  You can click the ![filter](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/icon/filter.jpg) icon to filter the operation records by execution result.  |
