...
2. In the left-side navigation pane, choose **+** > **Create Data Source** next to **Data Sources**.
    ...
    <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/433/300.quickstart/100.client-odc-quickstart/300.quickstart-using-client-odc.md/1EN.png" width="600">
...
3. In the **Create Data Source** panel that appears, specify the following information.
    ...
    <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/433/300.quickstart/100.client-odc-quickstart/300.quickstart-using-client-odc.md/2EN.png" width="900">
...
5. On the **Results** tab, view the execution records and logs.
