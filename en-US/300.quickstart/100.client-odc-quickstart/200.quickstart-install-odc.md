...
In personal development scenarios, you can also use the Client ODC. The Client ODC supports Windows, Mac, and Linux operating systems. Compared with Web ODC, the Client ODC provides only the complete features related to SQL development, and does not support control and collaboration features.
