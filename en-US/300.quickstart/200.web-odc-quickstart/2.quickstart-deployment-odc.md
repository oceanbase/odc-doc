...
6. Download the ODC image to obtain the desired image architecture:
   ...
   - [\[Image in x86 architecture\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.0-bp1/obodc4.3.0-bp1.tar.gz)<br>

   - [\[Image in ARM architecture\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.0-bp1/obodc4.3.0-bp1_arm.tar.gz)
