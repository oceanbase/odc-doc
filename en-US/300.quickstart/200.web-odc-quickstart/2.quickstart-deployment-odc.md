...
6. Download the ODC image to obtain the desired image architecture:
   ...
   - [\[Image in x86 architecture\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC%204.2.3/obodc4.2.3.tar.gz)<br>

   - [\[Image in ARM architecture\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC%204.2.3/obodc4.2.3_arm.tar.gz)
