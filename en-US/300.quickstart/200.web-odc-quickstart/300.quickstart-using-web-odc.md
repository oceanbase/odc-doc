...
1. Log in to Web ODC. In the left-side navigation pane of the project collaboration window, choose **User Permissions** > **Users**. On the **Users** tab, click **Create User**.
...
1. Log in to Web ODC. In the left-side navigation pane of the project collaboration window, choose **Data Sources** > **Create Data Source** > **Oracle**.
...
5. Click the database name **odc_test** in the database list, click **Log in to Database** in the upper-right corner of the **Databases** tab, or click **Log in to Database** in the **Actions** column of the database to log in to the database.
...
1. In the **odc_4.2.0** project, click **Log in to Database** to go to the SQL window.
