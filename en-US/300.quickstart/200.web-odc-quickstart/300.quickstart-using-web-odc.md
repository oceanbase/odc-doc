...
3. On the **Create Project** tab, configure the following parameters.
   ...
   | Administrator | The administrator that can manage all databases and members of the project.  |
...
1. In the **odc_4.2.0** project, click **Log on to Database** to go to the SQL window.
   ...
   ![sql1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/300.quickstart/200.web-odc-quickstart/300.quickstart-using-web-odc/sql1.png)

2. In the SQL window, edit SQL statements to create a table named `employee`.

   ![sql2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/300.quickstart/200.web-odc-quickstart/300.quickstart-using-web-odc/sql2.png)
...
3. After you complete editing SQL statements, click **Press F8** in the toolbar to run all SQL statements in the current SQL window.
   ...
   ![sql3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/300.quickstart/200.web-odc-quickstart/300.quickstart-using-web-odc/sql3.png)

4. On the result tab, you can view the execution records and logs.

   ![sql4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/300.quickstart/200.web-odc-quickstart/300.quickstart-using-web-odc/sql4.png)
