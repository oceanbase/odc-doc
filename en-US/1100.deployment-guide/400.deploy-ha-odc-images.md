...
1. Log in to ODC in Chrome. When the system prompts that the connection is not secure, click **Not Secure** on the left side of the address bar and click **Certificate** in the list that appears to view the certificate details.

    ![Image 739](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/5561103461/p284267.png)

2. In the **Certificate** window that appears, click the **<UI-TERM key="src.component.Task.ExportTask.CreateModal.5DF92911">Details</UI-TERM>** tab and click **Copy to File** in the lower-right corner of the tab.

    ![window2](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/6507903461/p394659.png)

3. In the **Certificate Export Wizard** step, click **<UI-TERM key="odc.component.VersionModal.Next">Next</UI-TERM>**.
