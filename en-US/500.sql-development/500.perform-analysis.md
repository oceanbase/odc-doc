...
| Type | Description |
| --- | --- |
| **<UI-TERM key="src.component.ProfileFlow.customComponents.5FAB7852">SQL Execution Overview</UI-TERM>** | <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/431/500.sql-development/500.perform-analysis/Execution%20Profile/4.9EN.png" width="600"><ul><li>**CPU time**: Total CPU time for all operators.</li><li>**I/O wait time**: Total I/O wait time for all operators.</li><li>**DB time**: Total time taken to execute the plan.</li><li>**Queue time**: Time spent waiting in the queue.</li><li>**Plan type**: Type of execution plan, which could be Local (LOCAL), Remote (REMOTE), or Distributed (DISTRIBUTED).</li><li>**Is hit plan cache**: Indicates whether the plan cache was hit.</li></ul> |
