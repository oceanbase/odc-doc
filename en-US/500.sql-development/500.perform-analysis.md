...
<li>For <strong>OceanBase V4.2.4 and later</strong>, but before <strong>OceanBase V4.3.0</strong>, or <strong>OceanBase V4.3.3.1</strong> and later, you can use the <strong>Execution Profile</strong> to monitor SQL execution in real-time. The Execution Profile helps you quickly view execution details and identify performance bottlenecks.</li>
</ul>
</main>
