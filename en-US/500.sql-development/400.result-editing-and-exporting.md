...
1. In the SQL window, write and execute an SQL statement to query data in the `employee` table.
   ...
   ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/1EN.png)
...
3. Click the plus sign (+) to add a row and edit data.
   ...
   ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/2EN.png)
...
5. In the **SQL Confirmation** dialog box, click **Execute**.
   ...
   ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/3EN.png)

6. The edited data is added to the result tab.

   ![4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/4EN.png)
...
1. In the result set, click ![export](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/sql-development/result%20editing%20and%20exporting/%E5%AF%BC%E5%87%BA.jpg).
   ...
   ![5](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/5EN.png)

2. In the **New Export Result Set** panel, specify the information of the export task and click **New**.

   ![6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/6EN.png)
...
3. On the **Ticket-Export Result Set** tab, click **View** in the **Actions** column of the task.
   ...
   ![7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/7EN.png)

4. In the **Task Details** panel, click **Download**.

   ![8](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/500.sql-development/400.result-editing-and-exporting/8EN.png)
