...
<main id="notice" type='notice'>
   <h4>Notice</h4>
   <p>After you connect OceanBase Developer Center (ODC) to OceanBase Database V2.1.0 or a later version in Oracle mode, you can create sequence objects in ODC. The MySQL mode does not support this feature.</p>
</main>
...
* [Create a sequence](../../../600.web-odc-user-guide/1100.web-odc-database-objects/500.web-odc-sequence-objects/200.web-odc-create-a-sequence.md)

* [Manage sequences](../../../600.web-odc-user-guide/1100.web-odc-database-objects/5.web-odc-sequence-objects/300.web-odc-manage-sequence.md)