...
| --- | --- | --- |
| Object Type | The ADT.<main id="notice" type="explain"><h4>Note</h4><p> Only the object type can contain a subprogram.</p></main> | ``` CREATE OR REPLACE TYPE ob_var AS OBJECT( var varchar2(10), var1 varchar(10) ); ``` |
