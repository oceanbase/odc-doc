...
* **<UI-TERM key="workspace.window.table.propstab.ddl">DDL</UI-TERM>** : displays the script that defines the type and provides the **Download** , **Find**, **Refresh** and **Format** buttons. You can click Edit to go to the type editing page.