...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>To manage a stored procedure, right-click the stored procedure name in the left-side navigation pane, and select the required operation from the context menu, which provides the following options: <strong>View</strong>, <strong>Create</strong>, <strong>Edit</strong>, <strong>Run</strong>, <strong>Download</strong>, <strong>Delete</strong>, and <strong>Refresh</strong>.For more information, see <a href="../4.web-odc-stored-procedure-objects/3.web-odc-manage-stored-procedures.md">Manage stored procedures</a>.</p>
</main>
