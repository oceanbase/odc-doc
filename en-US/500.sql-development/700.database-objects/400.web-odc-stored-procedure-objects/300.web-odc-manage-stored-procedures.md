...
| DDL | This section displays the script that defines the stored procedure and provides the **Edit**, **Download**, **Find**, **Format**, and **Refresh** buttons.  <main id="notice" type="explain"><h4>Note</h4><p>Click the **Edit** icon to go to the PL object editing page. </p></main>|
