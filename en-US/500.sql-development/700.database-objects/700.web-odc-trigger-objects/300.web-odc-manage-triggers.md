...
* **<UI-TERM key="workspace.window.table.propstab.ddl">DDL</UI-TERM>** : displays the script that defines the trigger and provides the **Edit** , **Find** , and **Refresh** buttons. You can click Edit to go to the trigger editing page.
