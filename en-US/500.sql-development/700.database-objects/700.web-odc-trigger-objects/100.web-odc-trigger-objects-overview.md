...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <ul>
  <li>After you connect ODC to OceanBase Database V2.2.20 or a later version in Oracle mode, you can create trigger objects in ODC. The MySQL mode does not support this feature.</li>
  <li>This chapter describes in different topics the operations you can perform on trigger objects in ODC.</li>
  </ul>
</main>

* [Create a trigger](200.web-odc-create-a-trigger.md)

* [Manage triggers](300.web-odc-manage-triggers.md)