...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>To manage a view, right-click the view name in the left-side navigation pane, and select the required operation from the context menu, which provides the following options: <strong>View</strong>, <strong>Create</strong>, <strong>Delete</strong>, <strong>Download</strong>, and <strong>Copy</strong>.</p>
</main>

For more information, see [Manage views](300.web-odc-manage-views.md).
