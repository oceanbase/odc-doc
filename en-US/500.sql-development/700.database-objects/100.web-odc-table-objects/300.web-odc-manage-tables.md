...
| Import | Click this option to import data to the table. For more information, see [Single table export and import](../../../600.import-and-export/100.import-data.md).  |
| Export  | Click this option to export data from the table. For more information, see [Single table export and import](../../../600.import-and-export/200.export-data.md).  |
