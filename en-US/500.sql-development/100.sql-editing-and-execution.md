...
2. In the SQL window, write an SQL statement to create a table named `employee`.
   ...
   ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/500.sql-development/sql4EN.png)
...
1. After you complete writing SQL statements, click **Press F8** in the toolbar to run all SQL statements in the current SQL window.
   ...
   ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/500.sql-development/sql5EN.png)

2. On the result tab, view the execution status and result.

   ![4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/500.sql-development/sql6EN.png)
...
1. In the SQL window, click the **Save Script** icon in the toolbar.
   ...
   ![7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/500.sql-development/script9EN.png)
