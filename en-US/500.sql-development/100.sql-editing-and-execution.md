...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/quickstart/webodc/sql%20editing/database.png" width="20" icon> and check whether the **employee** table is successfully created in the **odc_test** database in the **odc_4.2.0** project.
...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/sql-development/sql%20editing%20and%20execution/%E8%84%9A%E6%9C%AC.png" width="20" icon>. On the **Code Snippet** tab, click the plus sign (**+**) to create a snippet.
