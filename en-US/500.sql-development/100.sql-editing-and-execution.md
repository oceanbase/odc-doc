...
2. In the SQL window, write an SQL statement to create a table named `employee`.
   ...
   ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/2EN.png)
   ...
   In the SQL window shown in the preceding figure, click ![select a database](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/300.quickstart/200.web-odc-quickstart/300.quickstart-using-web-odc/sql%20editing%203.png) to switch to another database.
...
1. After you complete writing SQL statements, click **Press F8** in the toolbar to run all SQL statements in the current SQL window.
   ...
   ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/3EN.png)

2. On the result tab, view the execution status and result.

   ![4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/4EN.png)
...
1. In the left-side navigation pane of the SQL window, click ![database](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/quickstart/webodc/sql%20editing/database.png) and check whether the **employee** table is successfully created in the **odc_test** database in the **odc_4.2.0** project.
   ...
   ![5](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/5EN.png)

2. Right-click the **employee** table or write a `SELECT` statement in the SQL window to view the data in the table.

   ![6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/6EN.png)
...
1. In the SQL window, click the **Save Script** icon in the toolbar.
   ...
   ![7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/9EN.png)

2. Specify the script name and click **OK**.

   ![8](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/10EN.png)
...
2. On the **Script** tab, you can edit, download, delete, and refresh a saved script, copy the path of a script, and upload a script from your local disk.
   ...
   ![11](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/11EN.png)
...
2. On the **Create Snippet** page, specify the snippet information and click **OK**.
   ...
   ![14](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/14EN.png)

### Manage snippets

On the **Snippets** page, you can copy, edit, delete, and refresh a saved snippet.

![15](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/300.database-operation-and-maintenance/100.session-management/15EN.png)
