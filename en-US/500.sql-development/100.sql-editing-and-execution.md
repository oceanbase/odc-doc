|slug|sql-editing-and-execution|
|---|---|
...
1. After you complete writing SQL statements, click **<UI-TERM key="odc.EditorToolBar.actions.pl.RunF">Press F8</UI-TERM>** in the toolbar to run all SQL statements in the current SQL window. The following table describes the icons related to SQL statement execution.
...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/quickstart/webodc/sql%20editing/database.png" width="20" icon> and check whether the **<UI-TERM>employee</UI-TERM>** table is successfully created in the **<UI-TERM>odc_test</UI-TERM>** database in the **<UI-TERM>odc_4.2.0</UI-TERM>** project.
...
2. Right-click the **<UI-TERM>employee</UI-TERM>** table or edit a `SELECT` statement in the SQL window to view the data in the table.
...
3. Click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/430/500.sql-development/100.sql-editing-and-execution/8.1.png" width="20" icon> to manually synchronize metadata such as table columns in the current project or data source.

4. Right-click the name of a database and select **<UI-TERM key="src.page.Workspace.SideBar.ResourceTree.TreeNodeMenu.config.8485C0D3">Sync Metadata</UI-TERM>** to manually synchronize metadata such as table columns in the current database.
...
In ODC, you can save edited scripts in the SQL window or anonymous block window and manage saved scripts on the **<UI-TERM key="odc.Workspace.ActivityBar.type.Script">Script</UI-TERM>** tab.
...
1. In the SQL window, click the **<UI-TERM key="odc.component.SaveSQLModal.SaveScript">Save Script</UI-TERM>** icon in the toolbar.
...
2. Specify the script name and click **<UI-TERM key="src.page.Project.User.ManageModal.1C087F21">OK</UI-TERM>**.
...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/sql-development/sql%20editing%20and%20execution/%E8%84%9A%E6%9C%AC.png" width="20" icon> to go to the script management page.
...
2. On the **<UI-TERM key="odc.Project.Sensitive.interface.Script">Script</UI-TERM>** tab, you can edit, download, delete, and refresh a saved script, copy the path of a script, and upload a script from your local disk.
    ...
    <main id="notice" type="explain">
      <h4>Note</h4>
      <ul><li>You can click the name of a script to directly reference its content in the SQL window. </li><li>You can also copy the path of a script to reference its content in the command-line window. </li></ul>
    </main>
...
On the **<UI-TERM key="odc.SideBar.Script.CodeSnippet">Code Snippet</UI-TERM>** tab, you can save the snippet for creating the `employee` table.
...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/sql-development/sql%20editing%20and%20execution/%E8%84%9A%E6%9C%AC.png" width="20" icon>. On the **<UI-TERM key="odc.SideBar.Script.CodeSnippet">Code Snippet</UI-TERM>** tab, click the plus sign (**+**) to create a snippet.
...
2. On the **Create Snippet** page, specify the snippet information and click **<UI-TERM key="odc.components.SensitiveColumn.Ok">OK</UI-TERM>**.
...
On the **<UI-TERM key="odc.SideBar.Script.CodeSnippet">Code Snippet</UI-TERM>** tab, you can copy, edit, delete, and refresh a saved snippet.
