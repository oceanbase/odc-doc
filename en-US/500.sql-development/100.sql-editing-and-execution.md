...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/quickstart/webodc/sql%20editing/database.png" width="20"> and check whether the **<UI-TERM>employee</UI-TERM>** table is successfully created in the **<UI-TERM>odc_test</UI-TERM>** database in the **<UI-TERM>odc_4.2.0</UI-TERM>** project.
...
1. In the left-side navigation pane of the SQL window, click <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/420/sql-development/sql%20editing%20and%20execution/%E8%84%9A%E6%9C%AC.png" width="20">. On the **<UI-TERM key="odc.SideBar.Script.CodeSnippet">Code Snippet</UI-TERM>** tab, click the plus sign (**+**) to create a snippet.
