...
| **Level-1 parameter** | **Level-2 parameter** | **Level-3 parameter** | **Level-4 parameter** | **<UI-TERM key="odc.Header.Filter.Type">Type</UI-TERM>** | **Default value** | **<UI-TERM key="odc.Env.components.InnerEnvironment.Description">Description</UI-TERM>**                                                                                                                                                                               |
|------------------------|----------------------------------------------------------|-----------------------------|-----------|-----------------------|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **Parameter Name** | **<UI-TERM key="odc.CreateTable.Columns.columns.Type">Type</UI-TERM>** | **Scope** | **<UI-TERM key="odc.AlterDdlTask.DetailContent.Description">Description</UI-TERM>** |
| ------ | ------ | ------ | ------ |
...
1. In the project collaboration window, choose **<UI-TERM key="odc.page.ExternalIntegration.ExternalIntegration">External Integration</UI-TERM>** > **<UI-TERM key="odc.page.ExternalIntegration.ApprovalIntegration">Approval Integration</UI-TERM>** > **Create Approval Integration**.
