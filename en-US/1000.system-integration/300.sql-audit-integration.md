...
1. In the project collaboration window, choose **<UI-TERM key="odc.page.ExternalIntegration.ExternalIntegration">External Integration</UI-TERM>** > **<UI-TERM key="odc.ExternalIntegration.SqlInterceptor.SqlAuditIntegration">SQL Approval Integration</UI-TERM>** > **<UI-TERM>Create SQL Approval Integration</UI-TERM>**.
