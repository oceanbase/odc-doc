...
| **Level-1 parameter** | **Level-2 parameter** | **Level-3 parameter** | **Level-4 parameter** | **<UI-TERM key="odc.SSO.SSODetailDrawer.Type">Type</UI-TERM>** | **Default value** | **<UI-TERM key="odc.Env.components.InnerEnvironment.Description">Description</UI-TERM>** |
|-----------|---------------|-----------|-----------|-------------|----------|--------------|
...
1. In the project collaboration window, choose **<UI-TERM key="odc.page.ExternalIntegration.ExternalIntegration">External Integration</UI-TERM>** > **<UI-TERM key="odc.ExternalIntegration.SqlInterceptor.SqlAuditIntegration">SQL Approval Integration</UI-TERM>** > **Create SQL Approval Integration**.
...
3. Click **<UI-TERM key="odc.components.FormAutoAuthModal.Save">Save</UI-TERM>**. The SQL approval integration configuration is created.
...
In the SQL approval integration list, click **<UI-TERM key="odc.components.UserPage.See">View</UI-TERM>**, **<UI-TERM key="odc.components.CompileResult.Edit">Edit</UI-TERM>**, or **<UI-TERM key="odc.src.store.snippet.Delete">Delete</UI-TERM>** in the **<UI-TERM key="src.page.Project.User.ManageModal.Table.TaskApplyList.BC1F3BBD">Actions</UI-TERM>** column to view, edit, or delete information about the SQL approval integration configuration.


## References

- [SQL window specification](../700.database-change-management/500.sql-window-specification.md)

- [Approval integration](200.approval-integration.md)
