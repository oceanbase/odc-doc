...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>Online schema change tasks are supported only in MySQL tenants of OceanBase Database, and require OceanBase Migration Service (OMS) Enterprise Edition or Community Edition. </p>
</main>
...
10. Create a online schema change task.
    ...
    1. On the **<UI-TERM key="odc.page.Project.Ticket">Tickets</UI-TERM>** tab, choose **Online Schema Change** > **Create New**.
    ...
    4. After the online schema change task is generated, choose **<UI-TERM key="odc.page.Project.Ticket">Tickets</UI-TERM>** > **<UI-TERM>Online Schema Change</UI-TERM>** and view the task information in the task list.
...
1. In the online schema change task list, click **<UI-TERM key="src.component.Task.component.CommonDetailModal.178F11D7">View</UI-TERM>** in the **<UI-TERM key="odc.components.UserPage.Operation">Actions</UI-TERM>** column of the target task.
...
3. Click **<UI-TERM key="src.component.Task.component.ActionBar.C324AD20">Initiate Again</UI-TERM>** to initiate the online schema change task again.
