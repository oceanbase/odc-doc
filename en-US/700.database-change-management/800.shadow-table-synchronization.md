...
- [Manage database changes](../500.sql-development/700.database-objects/100.web-odc-table-objects/200.web-odc-create-a-table.md)

- [Manage partitions](../800.data-Lifecycle-management/300.partition-scheme-management/310.manage-partitioning-plans.md)

- [Change lock-free structures](../700.database-change-management/700.lock-free-schema-change.md)
