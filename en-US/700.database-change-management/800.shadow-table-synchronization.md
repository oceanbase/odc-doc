...
- [Manage partitions](../800.data-Lifecycle-management/300.partition-scheme.mdd)

- [Change lock-free structures](../700.database-change-management/700.table-structure-change.md)
