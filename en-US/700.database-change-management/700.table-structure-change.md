...
3. [Install OMS-CE 4.2.0_ce](https://www.oceanbase.com/docs/community-oms-cn-1000000000248267). You can obtain an OMS version that supports lock-free schema changes by using Docker.
