...
In the **Task Details** panel, click the **<UI-TERM key="workspace.window.sql.record.title">Execution Records</UI-TERM>** tab and view the task execution status.
...
| Parameter  |  Description  |
|---------|--------------|
| All Logs | Displays the complete information of all task logs, including **INFO**, **ERROR**, and **WARN** logs. You can click **<UI-TERM key="src.page.Workspace.SideBar.ResourceTree.DatabaseSearch.86200ED0">Search</UI-TERM>**, **<UI-TERM key="odc.component.Log.Download">Download</UI-TERM>**, or **<UI-TERM key="odc.component.Log.Copy">Copy</UI-TERM>** to search for, download, or copy all logs.        |
| Alert Logs | Displays the **ERROR** and **WARN** logs of the task. When a task fails, you can view the error messages in the alert logs. You can click **<UI-TERM key="workspace.window.session.button.search">Search</UI-TERM>**, **<UI-TERM key="odc.components.TriggerPage.Download">Download</UI-TERM>**, or **<UI-TERM key="odc.TaskManagePage.component.TaskTools.Copy">Copy</UI-TERM>** to search for, download, or copy alert logs. |
