...
Click **Delete** in the **Actions** column for an automatic authorization rule to delete the created rule.

## References

- [Users and Roles](100.odc-users-and-roles.md)

- [SSO integration](../../1000.system-integration/100.login-integration.md)