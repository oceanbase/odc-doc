...
1. After you [integrate OAuth2 in ODC and authenticate to log on to ODC](../../1000.system-integration/100.sso-integration.md), assume that the OAuth 2.0 system returns the following data structure:
...
- [Users and Roles](100.odc-users-and-roles.md)

- [SSO integration](../../1000.system-integration/100.sso-integration.md)