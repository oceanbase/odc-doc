...
The following figure shows the single table export page, which is basically the same as the [batch export page](../1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md). 
