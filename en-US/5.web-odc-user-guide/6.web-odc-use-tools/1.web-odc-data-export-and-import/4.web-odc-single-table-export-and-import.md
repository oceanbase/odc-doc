...
The following figure shows the single table export page, which is basically the same as the [batch export page](/en-US/5.web-odc-user-guide/6.web-odc-use-tools/1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md). 
...
10. View the export task. 
    ...
    After the export task is generated, the **Task Center** page automatically appears, where you can view the task information and download exported data files. For more information, see [Export tasks](/en-US/6.client-odc-user-guide/7.client-odc-task-management/3.client-odc-export-tasks.md).
...
1. Specify **Task Name** . 
   ...
   In the Export Single Table panel, ODC automatically generates a task name in **Task Name** field in the connection name_mode name_date format. You can modify the task name.
...
9. View the export task. 
   ...
   After the export task is generated, the **Task Center** panel automatically appears, where you can view the task information and download exported data files. For more information, see [Export tasks](/en-US/6.client-odc-user-guide/7.client-odc-task-management/3.client-odc-export-tasks.md).
...
The following figure shows the single table import page, which is basically the same as the [batch import](/en-US/5.web-odc-user-guide/6.web-odc-use-tools/1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md) page.
...
6. Specify **Data Format** . 
   ...
   You must specify this field when you select ZIP Files for **Import Format** . ODC only support importing data in **CSV format** and **SQL format** . For more information about formats, see [Export and import formats](/en-US/6.client-odc-user-guide/5.client-odc-use-tools/1.client-odc-data-export-and-import/2.client-odc-export-and-import-formats.md). If you specify **Import Schema Only** for **Import Content** or **SQL files** for **Import Format** , you do not need to select the data format.
...
12. View the import task. 
    ...
    After the task is generated, the **Task Center** page automatically appears, where you can view the task information. For more information, see [Import tasks](/en-US/6.client-odc-user-guide/7.client-odc-task-management/2.client-odc-import-tasks.md).
...
6. Specify **Data Format** . 
   ...
   You must specify this field when you select ZIP Files for **Import Format** . ODC only support importing data in **CSV format** and **SQL format** . For more information about formats, see [Export and import formats](/en-US/6.client-odc-user-guide/5.client-odc-use-tools/1.client-odc-data-export-and-import/2.client-odc-export-and-import-formats.md). If you specify **Import Schema Only** for **Import Content** or upload **SQL files** for **Import File** , you do not need to select the data format.
