...
You can right-click the target object in the sequence list to perform some **[Management actions](#tIcs0)** on the object. You can also double-click the target sequence in the sequence list to go to the **[sequence Management](#rJDpG)** page.![Image 196](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/2558659361/p241380.png)
...
| View Sequence   | Click this option to go to the **[sequence management page](#rJDpG)** , where you can view comprehensive information such as the basic information, attributes, and DDL statements of the sequence. |
| Modify          | Click this option to go to the Attribute tab of the **[sequence management page](#rJDpG)** to modify the information of the sequence.                                                               |
