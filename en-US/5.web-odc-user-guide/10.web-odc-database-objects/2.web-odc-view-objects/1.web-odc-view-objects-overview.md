...
* [Create a view](../../../6.client-odc-user-guide/9.client-odc-database-objects/2.client-odc-view-objects/2.client-odc-create-a-view.md)

  

* [Manage views](../../../6.client-odc-user-guide/9.client-odc-database-objects/2.client-odc-view-objects/3.client-odc-manage-views.md)
