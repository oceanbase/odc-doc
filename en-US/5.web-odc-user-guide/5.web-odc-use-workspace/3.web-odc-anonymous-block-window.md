...
An anonymous block window provides a [PL/SQL editing](#pl/sql-editing) area, the [PL/SQL Execution Result and DBMS Output](#pl/sql-execution-result-and-dbms-output) tabs, and the [Debugging](#debugging) page. 
