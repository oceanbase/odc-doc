...
* SQL window
  ...
  * On the **DB** tab of the **<UI-TERM key="odc.component.CommonTaskDetailModal.ExecutionRecord">Execution Records</UI-TERM>** page, you can view the full-link time consumption information about SQL statement execution.
