|slug|view-odc-related-full-link-logs|
|---|---|
...
* [View web ODC logs](../200.collect-message/200.view-web-odc-log.md)

* [View client ODC logs](../200.collect-message/300.view-client-odc-log.md)
