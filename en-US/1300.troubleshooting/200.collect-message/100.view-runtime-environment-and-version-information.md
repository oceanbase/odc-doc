|slug|view-runtime-environment-and-version-information|
|---|---|
...
Click the top right menu and choose **<UI-TERM>Firefox Help</UI-TERM>** > **<UI-TERM>About Firefox</UI-TERM>** and check the version number.
...
Choose **<UI-TERM key="odc.component.HelpMenus.Help">Help</UI-TERM>** > **<UI-TERM>About Developer Center</UI-TERM>** and check the ODC version.
