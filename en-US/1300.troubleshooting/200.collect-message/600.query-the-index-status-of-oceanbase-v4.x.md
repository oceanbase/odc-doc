...
<main id="notice" type='notice'>
  ...
  <li>For more information about how to query the index progress in OceanBase Database of a version from V1.4.x to V3.2.x, see <a href="700.query-the-index-status-of-oceanbase-v1.4.x-to-v3.2.x.md">Query the index status in OceanBase Database V1.4.x to V3.2.x</a>. </li>
  </ul>
</main>
