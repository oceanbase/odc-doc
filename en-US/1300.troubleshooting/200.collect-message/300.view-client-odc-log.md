...
1. Client ODC provides the built-in information collection feature. You can choose **<UI-TERM key="odc.component.HelpMenus.Help">Help</UI-TERM>** \> **<UI-TERM key="odc.component.GlobalHeader.Feedback">Feedback</UI-TERM>** \> **<UI-TERM>Generate information package</UI-TERM>** on the ODC home page to obtain logs.
...
2. Click **<UI-TERM>Generate information package</UI-TERM>** in the **<UI-TERM key="odc.components.ModalHelpFeedBack.Feedback">Feedback</UI-TERM>** window. ODC then generates a compressed file containing logs. Select a path to save the file.
