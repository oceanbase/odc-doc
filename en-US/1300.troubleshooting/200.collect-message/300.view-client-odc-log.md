...
1. Client ODC provides the built-in information collection feature. You can choose **<UI-TERM key="odc.component.HelpMenus.Help">Help</UI-TERM>** \> **<UI-TERM key="odc.component.GlobalHeader.Feedback">Feedback</UI-TERM>** \> **Generate information package** on the ODC home page to obtain logs.

    ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/KB/2.database-connection/3.view-client-odc-log/1.png)

2. Click **Generate information package** in the **<UI-TERM key="odc.components.ModalHelpFeedBack.Feedback">Feedback</UI-TERM>** window. ODC then generates a compressed file containing logs. Select a path to save the file.
