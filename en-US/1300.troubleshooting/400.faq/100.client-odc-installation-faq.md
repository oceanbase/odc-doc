|slug|client-odc-installation-faq|
|---|---|
...
* Method 1: Download the package from the documentation page of ApsaraDB for OceanBase
    ...
    Choose **<UI-TERM>Reference Guide</UI-TERM>** > **<UI-TERM>Download Clients</UI-TERM>** and click [Download Client ODC](https://www.alibabacloud.com/help/en/apsaradb-for-oceanbase/latest/download-the-odc-client?spm=a2c63.p38356.0.0.61da7e59lXJirt). Click the installation package of the desired version.
