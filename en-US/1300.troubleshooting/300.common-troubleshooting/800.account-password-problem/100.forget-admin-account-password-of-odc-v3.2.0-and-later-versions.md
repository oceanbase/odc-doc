|slug|forget-admin-account-password-of-odc-v3.2.0-and-later-versions|
|---|---|
...
<main id="notice" type='explain'>
  ...
  <li>For more information about how to reset a password in ODC V2.4.1 to V3.1.3, see <a href="200.forget-account-password-of-odc-v2.4.1-to-v3.1.3.md">How do I reset a password in ODC V2.4.1 to V3.1.3</a>. </li>
  <li>For more information about how to reset a password in ODC V2.4.0 or earlier, see <a href="300.forget-user-password-of-odc-v2.4.0-and-earlier-versions.md">How do I reset a password in ODC V2.4.0 or earlier</a>. </li>
  </ul>
</main>
