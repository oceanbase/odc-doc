|slug|chinese-character-garbled-error|
|---|---|
...
In MacOS, when the character set of the OBServer node is GBK, garbled Chinese characters appear in the results returned for an SQL statement executed in the SQL window.
