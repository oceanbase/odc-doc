...
2. After you identify the issue, you can check whether it is a known issue in [OceanBase Knowledge Base](https://www.oceanbase.com/knowledge-base). If the issue persists, analyze the issue. For more information, see [ODC troubleshooting guide](90.troubleshooting-overview.md).
...
If you cannot locate the cause of the issue based on the error message, analyze the issue based on logs. For more information, see [View end-to-end ODC-related logs](200.collect-message/400.view-odc-related-full-link-logs.md)
