...
2. After you identify the issue, you can check whether it is a known issue in [OceanBase Knowledge Base](https://www.oceanbase.com/knowledge-base). If the issue persists, analyze the issue. For more information, see [ODC troubleshooting guide](300.common-troubleshooting/100.deployment-upgrade/100.web-odc-cannot-be-accessed-after-startup.md).
