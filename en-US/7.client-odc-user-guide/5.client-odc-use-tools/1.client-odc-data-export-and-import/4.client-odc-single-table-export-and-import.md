...
The following figure shows the single table export page, which is basically the same as the [batch export page](/zh-CN/6.web-odc-user-guide/6.web-odc-use-tools/1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md). 
...
10. View the export task. 
    ...
    After the export task is generated, the **Task Center** page automatically appears, where you can view the task information and download exported data files. For more information, see [Export tasks](/zh-CN/7.client-odc-user-guide/8.client-odc-task-management/3.client-odc-export-tasks.md).
...
The following figure shows the single table import page, which is basically the same as the [Batch export and import](/zh-CN/7.client-odc-user-guide/5.client-odc-use-tools/1.client-odc-data-export-and-import/3.client-odc-batch-export-and-import.md) page.
...
6. Specify the data format. 
   ...
   You must specify this item when you select ZIP for **Import Format** . ODC only support importing data in **CSV format** and **SQL format** . For more information about formats, see [Export and import formats](/zh-CN/7.client-odc-user-guide/5.client-odc-use-tools/1.client-odc-data-export-and-import/2.client-odc-export-and-import-formats.md). If you specify **Import Schema Only** for **Import Content** or **SQL files** for **Import Format** , you do not need to select the data format.
...
12. View the import task. 
    ...
    After the task is generated, the **Task Center** page automatically appears, where you can view the task information. For more information, see [Import tasks](/zh-CN/7.client-odc-user-guide/8.client-odc-task-management/2.client-odc-import-tasks.md).
