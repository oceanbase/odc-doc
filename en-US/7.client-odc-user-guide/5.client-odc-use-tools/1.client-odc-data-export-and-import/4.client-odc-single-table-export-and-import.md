...
After you open a database connection, you can click **Table** in the left-side navigation pane to view the tables. Right-click the target table name in the table list or click Tool in the top navigation bar, and then click **Single Table Export** or **Single Table Import** in the list that appears to export or import data and schemas in the current table. 
