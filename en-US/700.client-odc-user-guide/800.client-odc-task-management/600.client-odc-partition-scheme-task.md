...
3. Click **Submit**.
   ...
   > For more information about task processes, see [Task process management](../../600.web-odc-user-guide/400.web-odc-public-resource-management/400.web-odc-task-process.md).
...
[Create a partitioning plan](../500.client-odc-use-tools/300.client-odc-partition-scheme.md)
