...
2. On the **Create Shadow Table Synchronization Project** panel, specify the following information.
   ...
   1. Select a synchronization object.
      ...
      ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/Client%20Shadow%20Table%20Synchronization%20Project%20task-EN1.png)
   ...
   2. Analyze the schema of the shadow table.
      ...
      ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/Client%20Shadow%20Table%20Synchronization%20Project%20task-EN2.png)
...
[Create a shadow table synchronization](../500.client-odc-use-tools/500.client-odc-shadow-table-synchronization.md)
