...
![Single Table Export - 1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/export%20import/sigle%20table%20export%201%20EN.png)

The procedure for exporting a single table is basically the same as the that of [batch export](../100.client-odc-data-export-and-import/300.client-odc-batch-export-and-import.md). The following example shows how to export an employee table in ODC. Procedure:
...
![Single Table Export - 2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/export%20import/sigle%20table%20export%202%20EN.png)
...
After the export task is generated, the **Task Center** page automatically appears, where you can view the task information and download exported data and schema files. For more information, see [Export tasks](../../800.client-odc-task-management/300.client-odc-export-tasks.md).

Single table import
-------------------------

![Single Table Import - 1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/export%20import/sigle%20table%20import%201%20EN.png)


Take the import of a CSV file in ODC as an example. The file contains an employee table. Procedure:
...
![Single Table Import - 2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/412/export%20import/sigle%20table%20import%202%20EN.png)
...
After the task is generated, the **Task Center** page automatically appears, where you can view the task information. For more information, see [Import tasks](../../800.client-odc-task-management/200.client-odc-import-tasks.md).
