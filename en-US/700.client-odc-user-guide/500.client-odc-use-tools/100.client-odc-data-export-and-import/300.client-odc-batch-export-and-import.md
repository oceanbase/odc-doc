...
10. View the export task. 
    ...
    After the export task is generated, the **Task Center** panel automatically appears, where you can view the task information and download exported data files. For more information, see [Export tasks](../../7.client-odc-task-management/3.client-odc-export-tasks.md).
