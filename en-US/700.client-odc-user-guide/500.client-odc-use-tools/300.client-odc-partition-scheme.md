...
- **Range partitioning**: Multiple rows with column values in an ordered, continuous, and non-overlapping range are assigned to a partition. For details, see [Set partitioning rules](../1000.client-odc-database-objects/100.client-odc-table-objects/200.client-odc-create-a-table.md).
...
[Partitioning plan task](../800.client-odc-task-management/600.client-odc-partition-scheme-task.md)
