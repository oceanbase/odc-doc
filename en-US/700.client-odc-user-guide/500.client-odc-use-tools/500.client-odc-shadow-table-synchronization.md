...
5. After the task is generated, the **Task Center** panel automatically appears, where you can view the task status and task information. For more information, see [Shadow table synchronization tasks](../800.client-odc-task-management/700.client-odc-shadow-table-synchronization-task.md).


## Related topics

[Shadow table synchronization tasks](../800.client-odc-task-management/700.client-odc-shadow-table-synchronization-task.md)
