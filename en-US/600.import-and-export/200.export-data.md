...
![1](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/5199620261/p270049.png)
...
![2](https://help-static-aliyun-doc.aliyuncs.com/assets/img/en-US/5199620261/p270050.png)
...
1. On the **Ticket** tab, choose **Data Export** > **Create New**
   ...
   ![2.0](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/2.0EN.png)

2. In the **Export** panel, specify **Export Content**.

   ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/3EN.png)
...
6. Configure data file settings.
   ...
   ![4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/4EN.png)
...
9. Complete the settings in the **sys Tenant Settings** section.
   ...
   b. Click **Test Connection** to verify whether the account information is correct. By default, the account for the connection settings is automatically filled in. If the connection fails, we recommend that you change the password for this export.
...
![5](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/5EN.png)
...
2. In the **Task Details** panel of the target task, click the **Task Information** tab to view the basic task information, file export information, and object information.

   ![6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/6EN.png)
...
![7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/7EN.png)

### Task logs

In the **Task Details** panel of the target task, click the **Task Logs** tab to view all logs and alert logs of the task.

![8](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/600.import-and-export/200.export-data/8EN.png)
