...
ODC supports importing ZIP (batch import and single-table import), SQL (batch import), and CSV (single-table import) file
s.
...
11. Complete the settings in the **sys Tenant Settings** section.
      ...
      <li>If no account of the sys tenant is specified, the import/export will be slow. </li>
      </ul>
      </main>
