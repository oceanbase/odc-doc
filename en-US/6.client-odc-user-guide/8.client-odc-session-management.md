...
After you enter a database connection in ODC, click **Session** in the top navigation bar and then choose **[Session Properties](#session-properties)** or **[Session Management](#session-management)** to go to the corresponding page. 
