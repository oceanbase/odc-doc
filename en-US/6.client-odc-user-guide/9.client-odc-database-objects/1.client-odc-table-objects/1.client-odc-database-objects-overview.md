...
* [Create a table](2.client-odc-create-a-table.md)

  

* [Table list](3.client-odc-table-list.md)

  

* [Manage table attributes](4.client-odc-manage-table-attributes.md)

  

* [Manage table data](5.client-odc-manage-table-data.md)
