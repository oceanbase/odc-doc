...
* **Mock Data** : Click this button to mock data in the table. For more information, see [Data mocking](/en-US/6.client-odc-user-guide/5.client-odc-use-tools/2.client-odc-data-mocking.md).
