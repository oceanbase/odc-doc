...
12. View the import task. 
    ...
    After the task is generated, the **Task Center** page automatically appears. On this page, you can view the task information. For more information, see [Import tasks](/en-US/6.client-odc-user-guide/7.client-odc-task-management/2.client-odc-import-tasks.md).
