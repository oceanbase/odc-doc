...
* Ticket management
   ...
   * Fixed the issue where a submitted ticket remains in the **<UI-TERM key="odc.component.TaskStatus.Queuing">Queuing</UI-TERM>** state for a long time but no error is returned.
