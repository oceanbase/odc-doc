...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>ODC will monitor the OceanBase version of MetaDB at startup. If the verification fails, the startup will fail. If your MetaDB cluster version is lower than V2.2.76, you need to upgrade the MetaDB cluster first.</p>
</main>
