...
OceanBase Developer Center (ODC) V3.3.3 released in August 2022 improves the PL debugging performance, concurrency of database change tasks, and startup speed of Client ODC, and optimizes other features.
...
* Deployment and upgrade
  ...
  * The first startup of the Client ODC on a Windows system is accelerated and takes about 30 seconds.
...
* Other modules
  ...
  * The Client ODC icon in macOS is optimized.
...
* Other modules
  ...
  * The Client ODC startup fails due to timeout in some scenarios in Windows.
