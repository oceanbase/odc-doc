...
* Database objects
   ...
   * If you log on to a MySQL tenant of OceanBase Database to view the properties of a view object in the `information_schema` database, the **<UI-TERM key="odc.components.CreateTable.BasicInformation">Basic Information</UI-TERM>** section is empty.
