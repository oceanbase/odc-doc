...
* Connection management
   ...
   * Fixed an issue that when you create a connection, after you enter the database username and password and click **<UI-TERM key="src.page.ExternalIntegration.SSO.NewSSODrawerButton.SSOForm.DCF54625">Test Connection</UI-TERM>**, the endpoint of the cloud service cannot be identified.
