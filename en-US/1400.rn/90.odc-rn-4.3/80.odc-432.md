...
- Partitioning plan
  ...
  - Fixed an issue where the database change subtask status did not match expectations when **<UI-TERM>Ignore Errors and Continue</UI-TERM>** was selected in the partitioning plan.  
