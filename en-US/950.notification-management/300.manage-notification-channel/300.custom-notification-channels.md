|slug|custom-notification-channels|
|---|---|
...
| Body | Specify the template for the notification content. If this parameter is not specified, no HTTP body is used. You can use a template to reference variables. For the list of variables, see [Create a notification channel](100.create-a-notification-channel.md). |
