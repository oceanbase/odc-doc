...
The following table describes the parameters to be specified when **<UI-TERM key="src.page.Project.Notification.components.2E263203">Channel Type</UI-TERM>** is **HTTP**.
