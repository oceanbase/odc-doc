|slug|create-a-notification-channel|
|---|---|
...
1. Log in to the OceanBase Developer Center (ODC) console. Choose **<UI-TERM key="odc.SpaceContainer.Sider.Project">Projects</UI-TERM>** > **<UI-TERM key="src.page.Project.B4D9BC23">Notification</UI-TERM>**. On the **<UI-TERM key="src.page.Project.B4D9BC23">Notification</UI-TERM>** tab, choose **<UI-TERM key="src.page.Project.Notification.87BBE655">Notification Channels</UI-TERM>** > **<UI-TERM key="src.page.Project.Notification.components.E4C2708A">Create Notification Channel</UI-TERM>**.
   ...
   <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/433/950.notification-management/300.manage-notification-channel/100.create-a-notification-channel/1EN.png" width="200">
