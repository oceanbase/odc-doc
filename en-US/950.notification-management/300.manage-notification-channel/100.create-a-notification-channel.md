...
3. Click **Send Test Message**. If a test message is successfully sent, click **<UI-TERM key="odc.components.FormUserModal.New">Create</UI-TERM>**.
...
- **<UI-TERM key="src.d.ts.01B0FD39">Resend</UI-TERM>**: After the throttling period of time elapses, notifications generated after the specified threshold is exceeded are automatically resent. The notifications are in the **To Be Sent** state before being resent.
