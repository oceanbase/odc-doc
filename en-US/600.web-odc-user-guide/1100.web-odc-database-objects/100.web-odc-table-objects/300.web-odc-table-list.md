...
| Import                          | Click this option to import data to the table. For more information, see [Single table export and import](../../600.web-odc-use-tools/100.web-odc-data-export-and-import/400.web-odc-single-table-export-and-import.md).                                          |
| Export                          | Click this option to export data from the table. For more information, see [Single table export and import](../../600.web-odc-use-tools/100.web-odc-data-export-and-import/400.web-odc-single-table-export-and-import.md).                                        |
