...
3. Click **Create** to complete the task application.
   ...
   > For more information about task processes, see [Manage task processes](../400.web-odc-public-resource-management/400.web-odc-task-process.md).
...
* [SQL plans](../600.web-odc-use-tools/600.web-odc-sql-plan.md)
