...
5. After the task is generated, the **Task Center** panel automatically appears, where you can view the task status and task information. For more information, see [Shadow table synchronization tasks](../900.web-odc-task-management/800.web-odc-shadow-table-synchronization-task.md).
...
* [Shadow table synchronization tasks](../900.web-odc-task-management/800.web-odc-shadow-table-synchronization-task.md)
