...
The procedure for exporting a single table is basically the same as the that of [batch export](../100.web-odc-data-export-and-import/300.web-odc-batch-export-and-import.md). The following example shows how to export an employee table in ODC. Procedure:
