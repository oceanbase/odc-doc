...
OceanBase Developer Center (ODC) allows you to connect to OceanBase Database and MySQL Database to edit and manage data sources, including database objects and resources. ODC can connect to OceanBase Database in MySQL and Oracle modes on Apsara Stack and Alibaba Cloud, and connect to MySQL Database.
...
1. Log on to Web ODC. In the left-side navigation pane of the project collaboration window, choose **Data Sources** > **Create Data Source** > **OceanBase MySQL**.
   ...
   ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/1EN.png)
...
2. In the **Create Data Source** panel, specify the following information.
   ...
   ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/create%20connection%202%20EN.png)
...
4. After the data source is created, you can view the created data source in the data source list.
   ...
   ![4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/4EN.png)
...
2. In the **Create Data Source** panel, specify the following information.
   ...
   ![5.0mysql](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/5mysql%20EN.png)
...
4. In the dialog box that appears, enter the data source name and click **OK**.
   ...
   ![6mysql](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/6mysql%20EN.png)
...
5. After the data source is created, you can view the created data source in the data source list.
   ...
   ![7mysql](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/7mysql%20EN.png)
...
1. On the **Data Source** page, choose **Create Data Source** > **Batch Import**.

   ![8](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/1EN.png)
