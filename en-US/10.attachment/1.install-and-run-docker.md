...
* [Install from repository](#install-from-repository): We recommend that you set up the Docker repository and install the Docker engine from it for easy installation and update.

  

* [Install from package](#install-from-package): You can manually download the RPM package of the Docker engine, install it, and then manage the update on your own. This method is quite useful when you need to install Docker on an air-gapped system that cannot access the Internet.

  

* [Install by using the convenience script](#install-by-using-the-convenience-script): In a testing or development environment, you can use the automatic convenience script to install Docker.
