...
2. On the **<UI-TERM key="odc.SpaceContainer.Sider.Ticket">Tickets</UI-TERM>** tab in the left-side navigation pane of the homepage, click **<UI-TERM key="odc.component.Task.helper.DataArchiving">Data Archiving</UI-TERM>** and then click **Create New**.
