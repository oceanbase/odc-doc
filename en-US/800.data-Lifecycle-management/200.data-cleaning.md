...
2. On the **<UI-TERM key="odc.SpaceContainer.Sider.Ticket">Tickets</UI-TERM>** tab in the left-side navigation pane of the homepage, click **<UI-TERM key="src.d.ts.237F5711">Data Cleanup</UI-TERM>** and then click **Create New**.
