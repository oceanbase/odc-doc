...
2. On the **<UI-TERM key="odc.SpaceContainer.Sider.Ticket">Tickets</UI-TERM>** tab of the SQL window, choose **<UI-TERM key="odc.src.component.Task.PartitionTask.DetailContent.Partition">Partitioning Plan</UI-TERM>** > **Create New**.
...
2. In the **Task Details** panel, click the **<UI-TERM key="odc.SSO.SSODetailDrawer.BasicInformation">Basic Information</UI-TERM>** tab and view the basic task information and task settings.
...
3. In the **Task Details** panel, click **<UI-TERM key="odc.TaskManagePage.component.TaskTools.InitiateAgain">Initiate Again</UI-TERM>** in the lower-right corner to initiate the task again.
...
1. In the **Task Details** panel, click the **<UI-TERM key="src.page.Workspace.components.SQLResultSet.D12A3FE9">Logs</UI-TERM>** tab to view all logs and alert logs of the task.
   ...
   | Tab  | Description |
   |------|-----------------------------|
   | All Logs | Displays the complete information of all task logs, including **INFO**, **ERROR**, and **WARN** logs. You can click **<UI-TERM key="src.page.Workspace.SideBar.ResourceTree.DatabaseSearch.86200ED0">Search</UI-TERM>**, **<UI-TERM key="odc.components.TriggerPage.Download">Download</UI-TERM>**, or **<UI-TERM key="app.button.copy">Copy</UI-TERM>** to search for, download, or copy all logs.        |
   | Alert Logs | Displays the **ERROR** and **WARN** logs of the task. When a task fails, you can view the error messages in the alert logs. You can click **<UI-TERM key="workspace.window.session.button.search">Search</UI-TERM>**, **<UI-TERM key="odc.components.SequencePage.Download">Download</UI-TERM>**, or **<UI-TERM key="src.component.ExecuteSqlDetailModal.68BF8995">Copy</UI-TERM>** to search for, download, or copy alert logs. |
