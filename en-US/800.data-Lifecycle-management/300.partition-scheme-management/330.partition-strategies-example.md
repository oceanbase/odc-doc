...
2. On the **<UI-TERM key="odc.page.Project.Ticket">Tickets</UI-TERM>** tab of the SQL window, choose **<UI-TERM key="odc.components.RecordPage.PartitionPlan">Partitioning Plan</UI-TERM>** > **Create New**.
...
6. Configure partition creation rules.
   ...
   - `parti_key`: The data type of this partitioning key is `INT`, which is not a time type. Therefore, you can select only **<UI-TERM key="odc.PermissionApplication.CreateModal.Custom">Custom</UI-TERM>** as the creation method. Assume that you need to use the current time as the reference time and create partitions at a time interval of 1 month. According to the description in the **Custom partition creation strategy** section of the “Set partitioning strategies” topic, you can perform the following steps to generate the partitioning expression:
...
6. Configure partition creation rules.
   ...
   - `KEY`: The data type of this partitioning key is `NUMBER`, which is not a time type. Therefore, you can select only **<UI-TERM key="src.component.Task.component.PartitionPolicyFormTable.EditTable.1ED9B737">Custom</UI-TERM>** as the creation method. Assume that you need to use the current system time as the reference time and create partitions at a time interval of 1 month. According to the description in the **Custom partition creation strategy** section of the “Set partitioning strategies” topic, you can perform the following steps to generate the partitioning expression:
