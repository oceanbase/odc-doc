...
1. In the SQL development window, choose **Tasks** > **<UI-TERM key="odc.TaskManagePage.component.helper.SqlPlan">SQL Plan</UI-TERM>** > **<UI-TERM key="odc.components.CreateSQLPlanTaskModal.CreateAnSqlPlan">Create SQL Plan</UI-TERM>**.
...
> **<UI-TERM key="odc.src.util.notification.Cue">Note</UI-TERM>**  
...
In the **Task Details** panel, click the **<UI-TERM key="odc.page.Secure.OperationRecord">Operation Records</UI-TERM>** tab to view the task information, such as **<UI-TERM key="odc.component.CommonTaskDetailModal.TaskOperationRecord.ApprovalStatus">Approval Status</UI-TERM>** and **<UI-TERM key="odc.component.CommonTaskDetailModal.FlowModal.ApprovalRecord">Approval Records</UI-TERM>**.