...
The following figure shows the single table export page, which is basically the same as the [Batch export](/zh-CN/6.web-odc-user-guide/6.web-odc-use-tools/1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md). 
...
The following figure shows the single table import page, which is basically the same as the [batch import](/zh-CN/6.web-odc-user-guide/6.web-odc-use-tools/1.web-odc-data-export-and-import/3.web-odc-batch-export-and-import.md) page.
