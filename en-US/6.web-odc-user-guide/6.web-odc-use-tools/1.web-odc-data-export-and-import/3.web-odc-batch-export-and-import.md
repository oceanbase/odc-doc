...
In the **Create Export Task** panel, you can export the schemas and data of multiple database objects to files in the specified format at the same time.
...
In the **Create Import Task** panel, you can choose to import the schemas and data to multiple database objects at the same time. 
