...
13. View the import task. 
    ...
    After the task is generated, the **Task Center** panel automatically appears, where you can view the task information. For more information, see [Import tasks](/zh-CN/7.client-odc-user-guide/8.client-odc-task-management/2.client-odc-import-tasks.md).
