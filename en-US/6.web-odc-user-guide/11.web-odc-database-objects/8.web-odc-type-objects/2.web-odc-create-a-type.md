...
<main id="notice" type='notice'>
   <h4>Note</h4>
   <p>ODC V3.2.2 and later versions support connection to OceanBase Community Edition. Due to the function differences of different OceanBase Database versions, the type function of ODC does not support the OceanBase Community Edition (The menu entry will be disabled).</p>
</main> 
