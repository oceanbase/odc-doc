...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <ul>
   <li>For an Oracle data source:<ul><li>You can only view the schemas of tables, views, functions, stored procedures, packages, triggers, types, sequences, and synonyms. </li><li>You can view and edit table data. </li><li>You can only run anonymous blocks. </li></ul></li>
   <li>For a PostgreSQL data source:<ul><li>You can only archive and clear data. </li>
   </ul></li>
   </ul>
</main>
...
- Execution Profile is supported to provide real-time SQL diagnostics only in OceanBase Database V4.2.4 and later V4.2.x versions, and V4.3.3.1 and later V4.3.x versions.

### Limitations on import and export

- The maximum size of data that can be exported in one batch in Web ODC is 2 GB before compression. To export data of a larger size, use the data export tool [obloader](https://en.oceanbase.com/docs/common-oceanbase-dumper-loader-10000000001865577).
...
- Pay attention to the following rules:
   ...
   - To archive data to a database, you must have the read and write permissions on the database, as well as the permissions to access internal views. For information about permission configuration, see [View user privileges](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001718213), [Overview](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001717357), and [Modify user privileges](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001169869).
