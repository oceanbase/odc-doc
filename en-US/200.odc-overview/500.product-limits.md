...
| Environment | Requirements |
| ------ | ------ |
| Operating system | <ul><li> Windows: Windows 7 or Windows 10 </li><li> macOS: 10.13.6 (17G65) </li><li> Linux: Ubuntu 18.x or Ubuntu 20.x </li></ul> |
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| SQL window | SQL execution | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | SQL check | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Auto-completion | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Execution plans | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Formatting | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Result set viewing | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Result set search | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Result set editing | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Result set export | ✔️ | ✔️ | ✔️ | ✔️ | ❌ |
|  | Script management | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Snippets | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Settings | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| GUI-based object management | Tables | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Views | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Functions | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
...
|  | Running | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Debugging | ✔️ | ❌ | ❌ | ❌ | ❌ |
| Tickets | Import | ✔️ | ✔️ | ✔️ | ✔️ | ❌ |
|  | Export | ✔️ | ✔️ | ✔️ | ✔️ | ❌ |
|  | Data mocking | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Database changes | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Synchronization of shadow tables | ❌ | ❌ | ✔️ | ✔️ | ❌ |
|  | SQL plans | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Partitioning plans | ❌ | ❌ | ✔️ | ✔️ | ❌ |
| Database O&M | Session management | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Session variable management | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
|  | Recycle bin management | ✔️ | ✔️ | ✔️ | ✔️ | ❌ |
|  | Command-line window | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
