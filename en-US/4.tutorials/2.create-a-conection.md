...
* Client ODC has been installed or web ODC has been deployed. For the deployment of web ODC, contact your technical support personnel. For the installation of client ODC, see Install ODC.

  

* If you are using web ODC, you have logged to ODC and entered the connection management page. For more information, see [Log on to ODC](../5.web-odc-user-guide/1.log-on-to-odc/1.log-on-to-odc-account.md).
