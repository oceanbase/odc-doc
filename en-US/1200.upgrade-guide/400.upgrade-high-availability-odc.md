...
1. To obtain the ODC image on the host, select the required image from the Maintenance Tools of the [OceanBase Download Center](https://www.oceanbase.com/softwarecenter).
