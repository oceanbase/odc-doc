...
After you log in to ODC, click Help Center in the upper-right corner of the connection list page. Then, click **<UI-TERM>About Developer Center</UI-TERM>** in the drop-down list, and a window appears. You can view the ODC version number in this window to check whether the upgrade is succeeded. For more information about the use of Web ODC, see User Guide (Web ODC).
