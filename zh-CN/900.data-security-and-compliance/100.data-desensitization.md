...
1. 在 SQL 开发窗口的左侧导航栏中，通过工单 **[新建数据库变更](../700.database-change-management/500.database-change.md)**，插入数据到表 student 中。
...
1. 在 SQL 窗口中，**[编辑 SQL 语句](../700.database-change-management/500.database-change.md)**，插入数据到表 student 中。
