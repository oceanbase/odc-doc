...
如上图所示，在 **敏感数据** 列表中，单击操作项下的 **<UI-TERM key="odc.ResourceTree.config.treeNodesActions.Editing">编辑</UI-TERM>** 按钮，可以修改敏感列的脱敏算法。
...
在 **敏感数据** 列表中，单击操作项下的 **<UI-TERM key="odc.TableConstraint.Primary.Delete">删除</UI-TERM>** 按钮，可以删除敏感列。
