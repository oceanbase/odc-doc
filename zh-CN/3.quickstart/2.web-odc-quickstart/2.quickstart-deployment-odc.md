...
<main id="notice" type='explain'>
   <h4>说明</h4>
   <p>环境要求请参见 <a href="../../200.odc-overview/5.product-limits.md">使用限制</a>。</p>
...
6. 下载 ODC 镜像以获取所需的镜像架构版本：
   ...
   - [\[X86 镜像\]](https://ob-front.oss-cn-hangzhou.aliyuncs.com/client/4.1.3/obodc4.1.3.tar.gz)<br>

   - [\[ARM 镜像\]](https://ob-front.oss-cn-hangzhou.aliyuncs.com/client/4.1.3/obodc4.1.3_arm.tar.gz)
...
2. 输入账号和密码，登录 Web 版 ODC。
   ...
   <main id="notice" type='explain'>
      <h4>说明</h4>
      <p>您还可以通过 SSO 集成自动维护账号信息，详情请参见  《系统集成.单点登录》请参见 <a href="../../1500.system-integration/1.sso-integration.md">单点登录配置</a>。</p>
   </main> 
...
- [部署 Web 版 ODC](../../1600.deployment-guide/1.deployment-overview.md)