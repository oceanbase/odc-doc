...
2. 确定问题后，可以从 [OceanBase 知识库](https://www.oceanbase.com/knowledge-base) 中检索是否为已知问题。如仍未解决问题，请参见 [ODC 故障排查指南](https://www.oceanbase.com/knowledge-base/odc-1000000000340780) 进行分析。
...
| 客户名称 | 出现问题的客户名称。 |
| 用户角色 | DBA/ 开发/测试/运维/ ... |
| ODC 版本 | <ul><li> 版本号。  </li><li> Web 版/Windows 桌面版/MacOS 桌面版。</li></ul> |
