...
1. SQL 窗口默认为共享 Session 模式，您可以在 **偏好设置** 或者 **<UI-TERM key="odc.components.RecordPage.PersonalSettings">个人设置</UI-TERM>** 中设置 SQL 窗口的 Session 模式。

    a. 入口一：登录 ODC 后，在 ODC 首页的左侧导航栏中，单击 **<UI-TERM key="odc.Index.Sider.Mine">我的</UI-TERM>** > **偏好设置**。
...
1. 在 ODC 窗口左侧导航栏的左下角，单击 **<UI-TERM key="odc.Index.Sider.Mine">我的</UI-TERM>** > **偏好设置**。
