...
桌面版 ODC 支持 Windows、MacOS 操作系统，用户可以通过以下站点下载 ODC 桌面版安装包。
...
通过 `sudo spctl --master-disable` 后，选择任何来源。
...
macOS 暂不支持直接安装，您可以参照 Apple 的支持文档查看如何安全的打开非通过 Apple Store 下载的应用，详情请参见文章[在 MacOS 上安全地打开 App](https://support.apple.com/zh-cn/guide/mac-help/mchleab3a043/mac)。