...
* [新建视图](../../../7.client-odc-user-guide/9.client-odc-database-objects/2.client-odc-view-objects/2.client-odc-create-a-view.md)

  

* [管理视图](../../../7.client-odc-user-guide/9.client-odc-database-objects/2.client-odc-view-objects/3.client-odc-manage-views.md)
