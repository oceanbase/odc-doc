...
| ------ | ------ | ------ | ------ | ------ | ------ | ------------ | --------- | --------- | --------- |
| 管控协同 | 变更审批 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
|  | SQL 窗口规范 | 是 | 是 | 是 | 是 | 是 | 是 | 否 | 是 |
|  | SQL 检查规范 | 是 | 是 | 是 | 是 | 是| 是| 否 | 否 |
| 安全合规 | 数据脱敏 | 是| 是| 是| 是| 否 | 是| 是| 是|
|  | 操作记录 | 是| 是| 是| 是| 是| 是| 是| 是|
| 数据生命周期 | 数据清理 | 是| 是| 是| 是| 否 | 是| 否 | 否 |
|  | 数据归档 | 是| 是| 是| 是| 否 | 是| 否 | 否 |
|  | 分区计划 | 是| 是| 是| 是| 否 | 否 | 否 | 否 |
| SQL 窗口 | SQL 执行 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | SQL 检查 | 是| 是| 是| 是| 是| 是| 否 | 否 |
|  | 自动补全 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 执行计划 | 是| 是| 是| 是| 否 | 是| 否 | 否 |
|  | 格式化 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 全链路追踪 | 是| 是| 是| 是| 否 | 否 | 否 | 否 |
|  | 结果集查看 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 结果集搜索 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 结果集编辑 | 是| 是| 是| 是| 是| 是| 否 | 是|
|  | 结果集导出 | 是| 是| 是| 是| 否 | 是| 是| 是|
|  | 脚本管理 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 代码片段 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 设置 | 是| 是| 是| 是| 是| 是| 是| 是|
| 白屏对象管理 | 表 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 视图 | 是| 是| 是| 是| 否 | 是| 是| 否 |
|  | 函数 | 是| 是| 是| 是| 否 | 是| 是| 否 |
|  | 存储过程 | 是| 是| 是| 是| 否 | 是| 是| 否 |
|  | 程序包 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
|  | 触发器 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
|  | 类型 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
|  | 序列 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
|  | 同义词 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
|  | 匿名块 | 是| 是| 否 | 否 | 否 | 否 | 是| 否 |
| PL 能力 | 编译 | 是| 是| 是| 是| 否 | 否 | 否 | 否 |
|  | 运行 | 是| 是| 是| 是| 否 | 是| 否 | 否 |
|  | 调试 | 是| 否 | 否 | 否 | 否 | 否 | 否 | 否 |
| 工单 | 导入 | 是| 是| 是| 是| 否 | 是| 是| 是|
|  | 导出 | 是| 是| 是| 是| 否 | 是| 是| 是|
|  | 模拟数据 | 是| 是| 是| 是| 否 | 是| 否 | 否 |
|  | 数据库变更 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 影子表同步 | 否 | 否 | 是| 是| 否 | 否 | 否 | 否 |
|  | SQL 计划 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 无锁结构变更 | 是| 是| 否 | 否 | 否 | 否 | 否 | 否 |
| 数据库运维 | 会话管理 | 是| 是| 是| 是| 是| 是| 是| 是|
|  | 会话变量管理 | 是| 是| 是| 是| 是| 是| 否 | 是|
|  | 回收站管理 | 是| 是| 是| 是| 否 | 否 | 否 | 否 |
|  | 命令行窗口 | 是| 是| 是| 是| 是| 是| 否 | 是|
