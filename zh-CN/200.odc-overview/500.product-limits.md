...
| 类别 | 功能 | OceanBase Oracle | OB Cloud Oracle | OceanBase MySQL | OB Cloud MySQL | OB Sharding MySQL | MySQL | Oracle | Doris |
| ------ | ------ | ------ | ------ | ------ | ------ | ------------ | --------- | --------- | --------- |
| 管控协同 | 变更审批 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | SQL 窗口规范 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 支持|
|  | SQL 检查规范 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 不支持 |
| 安全合规 | 数据脱敏 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 支持|
|  | 操作记录 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
| 数据生命周期 | 数据清理 | 支持| 支持| 支持| 支持| 不支持 | 支持| 不支持 | 不支持 |
|  | 数据归档 | 支持| 支持| 支持| 支持| 不支持 | 支持| 不支持 | 不支持 |
|  | 分区计划 | 支持| 支持| 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 |
| SQL 窗口 | SQL 执行 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | SQL 检查 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 不支持 |
|  | 自动补全 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 执行计划 | 支持| 支持| 支持| 支持| 不支持 | 支持| 不支持 | 不支持 |
|  | 格式化 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 全链路追踪 | 支持| 支持| 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 |
|  | 结果集查看 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 结果集搜索 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 结果集编辑 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 支持|
|  | 结果集导出 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 支持|
|  | 脚本管理 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 代码片段 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 设置 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
| 白屏对象管理 | 表 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 视图 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 不支持 |
|  | 函数 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 不支持 |
|  | 存储过程 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 不支持 |
|  | 程序包 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
|  | 触发器 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
|  | 类型 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
|  | 序列 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
|  | 同义词 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
|  | 匿名块 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 支持| 不支持 |
| PL 能力 | 编译 | 支持| 支持| 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 |
|  | 运行 | 支持| 支持| 支持| 支持| 不支持 | 支持| 不支持 | 不支持 |
|  | 调试 | 支持| 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 工单 | 导入 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 支持|
|  | 导出 | 支持| 支持| 支持| 支持| 不支持 | 支持| 支持| 支持|
|  | 模拟数据 | 支持| 支持| 支持| 支持| 不支持 | 支持| 不支持 | 不支持 |
|  | 数据库变更 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 影子表同步 | 不支持 | 不支持 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 |
|  | SQL 计划 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 无锁结构变更 | 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 数据库运维 | 会话管理 | 支持| 支持| 支持| 支持| 支持| 支持| 支持| 支持|
|  | 会话变量管理 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 支持|
|  | 回收站管理 | 支持| 支持| 支持| 支持| 不支持 | 不支持 | 不支持 | 不支持 |
|  | 命令行窗口 | 支持| 支持| 支持| 支持| 支持| 支持| 不支持 | 支持|

<main id="notice" type='explain'>
   <h4>说明</h4>
   <p>关于 Oracle 数据源：</p>
   <ul>
   <li>表、视图、函数、存储过程、程序包、触发器、类型、序列、同义词对象仅支持结构查看。</li>
   <li>表数据支持查看、编辑。</li>
   <li>匿名块仅支持运行。</li>
   </ul>
</main>
...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <ul>
  <li>若数据源为 OceanBase，有且仅能通过 OBProxy 连接，该实例将否调试。</li>
  <li>匿名块窗口仅在 OceanBase Oracle/OB Cloud Oracle 数据源提供。</li>
  <li>ODC V3.2.3 之前版本否在 ARM 架构下进行调试。</li>
  </ul>
</main>

### SQL 开发限制

- 编辑结果集时，否对包含 SET、ENUM 字段类型的查询结果集进行编辑。
...
- 支持的变更影响行数上限为 100W，超过则否自动生成回滚语句。

- 若表中包含大字段，否自动生成回滚语句。

- OceanBase MySQL、MySQL 数据源下，若表中无主键或者唯一键，否自动生成回滚语句。

- UPDATE 语句的修改字段（Set）和条件字段（Where）相同，否自动生成回滚语句。
...
- Range 分区表中的最后一个分区上限值为 MAXVALUE 时，数据库不允许新增分区，因此否通过 ODC 分区计划任务创建分区策略。
...
- 仅支持比对表对象，比对属性范围仅包含列、主键、约束、索引、分区、表属性。
  ...
  - 关于分区，仅支持比对一级分区否比对二级分区。

  - 关于表属性，仅支持比对字符集、排序规则、注释。

- OceanBase MySQL 否比对检查约束。

- OceanBase MySQL V1.4.79 之前版本，如果没有 sys 租户查询权限，否对比分区属性。 
...
- 前置条件：
   ...
   - OceanBase 数据源必须通过 OBproxy 连接（暂否对直连的 OceanBase 进行归档操作）。

   - OceanBase 数据源目前仅支持集群实例，新建数据源时必须配置集群名称。

   - 需保证源端表字段在目标端兼容，数据归档不处理字段兼容性问题。

   - MySQL 数据源暂否 CPU 内存防爆能力。

   - 二级分区否表结构同步，异构数据库否结构同步以及自动建表。

- 归档链路支持：

   - OceanBase MySQL 到 OceanBase MySQL 。

   - OceanBase Oracle 到 OceanBase Oracle （暂否同步表结构）。
...
- 以下情况否归档：
  ...
  - OceanBase MySQL 及 MySQL 数据源若表中不包含主键 PRIMARY KEY 或唯一非空索引，否进行归档。

  - OceanBase Oracle 数据源若表中不包含主键 PRIMARY KEY，否进行归档。

  -   OceanBase Oracle 数据源若表中包含 JSON、XMLTYPE 字段类型，否进行归档。

   - OceanBase Oracle 数据源否 V4.3.0 及以上版本。

   - OceanBase MySQL 数据源否 V4.3.1 及以上版本。

   - 若归档条件中包含 limit 语句，否进行归档。
...
- 以下情况否清理：
  ...
  - OceanBase MySQL 及 MySQL 数据源若表中不包含主键 PRIMARY KEY 或唯一非空索引，否进行清理。
  
  - OceanBase Oracle 数据源若表中不包含主键 PRIMARY KEY，否进行清理。
  
  - OceanBase Oracle 数据源若表中包含 JSON、XMLTYPE 字段类型，否进行归档。

   - OceanBase Oracle 数据源否 V4.3.0 及以上版本。

   - OceanBase MySQL 数据源否 4.3.1 及以上版本。

   - 若归档条件中包含 limit 语句，否进行清理。
...
- 执行数据库变更任务期间，不允许终止该任务流程。即目前自动模式下否终止任务流程。手动执行时，在等待下一批次执行前可以终止任务流程，数据库变更时不可终止任务流程。

### 逻辑库变更

- 仅支持 OceanBase MySQL、MySQL 数据源。

- 仅支持对 UPDATE、ALTER 和 DROP 的 SQL 变更语句。
