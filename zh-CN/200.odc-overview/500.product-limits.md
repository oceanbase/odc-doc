...
| Java | JDK >= 1.8.0_200 且 JDK < 9<main id="notice" type="explain"><h4>说明</h4><p>ODC V3.2.0 及之后的版本，桌面版安装包中已附加 JRE 安装包（包含 MacOS 和 Win 64 位平台），不依赖部署环境的 JRE。</p></main> |
...
|| SQL 窗口规范 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 不支持 |
|| SQL 检查规范 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 不支持 | 不支持 |
| 安全合规 | 数据脱敏 | 支持 | 支持 | 支持 | 支持 | 不支持 | 支持 | 支持 | 支持 | 不支持 |
|| 操作记录 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 不支持 |
| 数据生命周期 | 数据清理 | 支持 | 支持 | 支持 | 支持 | 不支持 | 支持 | 支持 | 不支持 | 支持 |
|| 数据归档 | 支持 | 支持 | 支持 | 支持 | 不支持 | 支持 | 支持 | 不支持 | 支持 |
|| 分区计划 | 支持 | 支持 | 支持 | 支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| SQL 窗口 | SQL 执行 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 不支持 |
|| SQL 检查 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 支持 | 不支持 | 不支持 |
...
|| 外表 | 支持 | 支持 | 支持 | 支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
...
|| 调试 | 支持 | 支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
...
|| 无锁结构变更 | 不支持 | 不支持 | 支持 | 支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
|| 结构比对 | 支持 | 支持 | 支持 | 支持 | 不支持 | 支持 | 不支持 | 不支持 | 不支持 |
|| 多库变更 | 支持 | 支持 | 支持 | 支持 | 不支持 | 支持 | 支持 | 支持 | 不支持 |
...
| 逻辑库 | 逻辑库配置 | 不支持 | 不支持 | 支持 | 支持 | 不支持 | 支持 | 不支持 | 不支持 | 不支持 |
|| 逻辑库 DDL | 不支持 | 不支持 | 支持 | 支持 | 不支持 | 支持 | 不支持 | 不支持 | 不支持 |

<main id="notice" type="explain">
  <h4>说明</h4>
  <ul><li>关于 Oracle 数据源：<ul><li>表、视图、函数、存储过程、程序包、触发器、类型、序列、同义词对象仅支持结构查看。</li><li>表数据支持查看、编辑。</li><li>匿名块仅支持运行。</li></ul></li><li>关于 PostgreSQL 数据源：<ul><li>仅支持数据归档、数据清理。</li></ul></li></ul>
</main>
...
* 为了避免其它操作对元数据库的影响，建议使用独立的数据库作为 ODC 的元数据库。用于 ODC 访问元数据库的用户需要拥有该库的所有权限。授权数据库所有权限：`GRANT ALL PRIVILEGES ON odc_metadb.* TO 'user'@'host';`。
...
| 调试 | 函数/存储过程/匿名块 | OceanBase Oracle<br>OB Cloud Oracle | V3.2.3 及之后版本。 |
...
<main id="notice" type="notice">
  <h4>注意</h4>
  <ul><li>匿名块窗口仅在 OceanBase Oracle/OB Cloud Oracle 数据源提供。</li><li>ODC V3.2.3 之前版本不支持在 ARM 架构下进行调试。</li></ul>
</main>
...
* SQL 实时剖析仅支持 OceanBase V4.2.4 及之后的版本、V4.3.3.1 及之后的版本。
...
* 默认通过锁定用户且关闭会话的方式避免表名切换过程中数据的写入，部分版本（OceanBase MySQL V4.2.5 及之后且 OceanBase MySQL V4.3.0 之前的版本）通过特定配置以 `LOCK TABLE` 方式避免数据写入。具体配置请参见 [新建无锁结构变更任务](../700.database-change-management/700.lock-free-schema-change.md)。
