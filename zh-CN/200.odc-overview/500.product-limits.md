...
|  数据库类型  |  支持版本  |
|-----------|-----------|
| OceanBase | <ul><li> OceanBase V1.4.x</li><li> OceanBase V2.0.x</li><li> OceanBase V2.1.x</li><li> OceanBase V2.2.x</li><li> OceanBase V3.1.x</li><li> OceanBase V3.2.x</li>   <li>OceanBase V4.0.0 </li>   <li>OceanBase V4.1.0</li><li>OceanBase V4.2.0</li><li>OceanBase V4.2.1</li><li>OceanBase 社区版（PL 相关能力不支持）</li></ul>     |
