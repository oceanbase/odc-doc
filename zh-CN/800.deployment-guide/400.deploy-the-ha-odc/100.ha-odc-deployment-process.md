|slug|ha-odc-deployment-process|
|---|---|
...
4. [配置证书信任](../4.deploy-the-ha-odc/5.configure-certificate-trust.md)：某些浏览器不会直接信任自签证书，需在浏览器中手动配置证书信任。
   ...
   <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>Web ODC 管理员的初始用户名为 admin，在部署 Web ODC 时可以通过环境变量 <code>ODC_ADMIN_INITIAL_PASSWORD</code>设置 ODC 管理员账号的初始密码。具体设置请参考 <a href="../4.deploy-the-ha-odc/2.load-and-run-ha-odc-images.md">加载和运行 ODC 镜像</a>。</p>
   </main>
