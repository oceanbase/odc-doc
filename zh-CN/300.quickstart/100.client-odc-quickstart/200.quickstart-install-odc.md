...
在个人开发场景，您也可以选择 ODC 桌面版，ODC 桌面版支持 Windows/MacOS 操作系统。与 Web 版 ODC 相比，ODC 桌面版同样提供了 SQL 开发相关的完整功能，但是不包含管控协同相关的功能。

#### 安装环境要求

|环境  | 要求 |
|---------|---------|
| 操作系统| <ul><li>Windows：Win 7/Win 10。</li><li>Mac：10.13.6（17G65）。</li></ul> |
