...
在个人开发场景，您也可以选择 ODC 桌面版，ODC 桌面版支持 Windows/Mac 操作系统。与 Web 版 ODC 相比，ODC 桌面版同样提供了 SQL 开发相关的完整功能，但是不包含管控协同相关的功能。桌面版 ODC 安装环境要求请参见 [使用限制](../../200.odc-overview/500.product-limits.md)。
