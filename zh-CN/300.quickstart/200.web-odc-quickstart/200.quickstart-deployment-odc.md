...
6. 下载 ODC 镜像以获取所需的镜像架构版本：
   ...
   - [\[X86 镜像\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.0-bp1/obodc4.3.0-bp1.tar.gz)<br>

   - [\[ARM 镜像\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.0-bp1/obodc4.3.0-bp1_arm.tar.gz)
