...
6. 下载 ODC 镜像以获取所需的镜像架构版本：
   ...
   - [\[X86 镜像\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.2/obodc4.3.2.tar.gz)<br>

   - [\[ARM 镜像\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.3.2/obodc4.3.2_arm.tar.gz)
