...
1. 在项目协同窗口，单击 **<UI-TERM key="odc.component.AuthNode.ExternalIntegration">外部集成</UI-TERM>** > **<UI-TERM key="odc.ExternalIntegration.SqlInterceptor.ApprovalIntegration">审批集成</UI-TERM>** > **<UI-TERM>新建审批集成</UI-TERM>**。
...
2. 在弹出的 **<UI-TERM>新建审批集成</UI-TERM>** 面板中填写或选择以下信息。
