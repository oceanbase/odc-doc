...
- LDAP（轻量级目录访问协议）用于访问和管理目录信息服务的行业标准协议。其通常用于存储和检索有关网络环境中的用户、组、组织结构和其它资源的信息。
...
1. 登录 Web 版 ODC 后，在项目协同窗口中，单击 **外部集成** > **登录集成** > **新建登录集成**。
   ...
   ![3.2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/3.2.png)
...
5. 测试连接成功后，返回用户信息 API 的结构，根据返回的信息填写用户字段映射相关参数。
   ...
   ![6.7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/6.7.png)
...
8. 在 Web ODC 的登录页面，单击 **OAUTH2** 跳转到第三方登录界面，使用第三方登录账号访问到 ODC。
   ...
   ![6.9](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/6.9.png)
...
1. 登录 Web 版 ODC 后，在项目协同窗口中，单击 **外部集成** > **登录集成** > **新建登录集成**。
   ...
   ![7.1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/7.1.png)
...
5. 测试连接成功后，返回用户信息 API 的结构，根据返回的信息填写用户字段映射相关参数。
   ...
   ![9.1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/9.1.png) 
...
1. 登录 Web 版 ODC 后，在项目协同窗口中，单击 **外部集成** > **登录集成** > **新建登录集成**。
   ...
   ![ldap1.0](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/ldap1.0.png)
...
4. 输入第三方登录账号和密码。
   ...
   ![ldap2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/ldap2.png)
...
5. 测试连接成功后，返回用户信息 API 的结构，根据返回的信息填写用户字段映射相关参数。
   ...
   ![ldap3.0](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/ldap3.0.png) 
...
8. 在 Web ODC 的登录页面，单击 **LDAP**，使用第三方登录账号访问到 ODC。
   ...
   ![ldap5.0](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/ldap5.0.png)

## 管理登录集成

在登录集成列表中，您可以启用/查看/编辑/删除创建的登录集成。

![10.1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/424/1000.system-integration/100.sso-integration/10.1.png)
