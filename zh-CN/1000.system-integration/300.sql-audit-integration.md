...
1. 在项目协同窗口，单击 **<UI-TERM key="odc.page.ExternalIntegration.ExternalIntegration">外部集成</UI-TERM>** > **<UI-TERM key="odc.ExternalIntegration.SqlInterceptor.SqlAuditIntegration">SQL 审核集成</UI-TERM>** > **<UI-TERM>新建 SQL 审核集成</UI-TERM>**。
