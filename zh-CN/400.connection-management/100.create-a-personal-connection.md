...
2. 在弹出的 **新建数据源** 面板中填写或选择以下信息。
   ...
   ![6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/400.connection-management/100.create-a-personal-connection/2.png)
...
4. 在弹窗中自定义数据源名后，单击 **确定** 按钮，即可将当前的配置信息持久保存在 ODC 数据源列表中。
   ...
   ![7](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/400.connection-management/100.create-a-personal-connection/3.png)
...
5. 创建完成后，可在数据源列表中查看创建的数据源。
   ...
   ![8](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/400.connection-management/100.create-a-personal-connection/4.png)
