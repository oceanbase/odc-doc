...
2. 在弹出的 **新建数据源** 面板中填写或选择以下信息。
   ...
   ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/422/400.connection-management/100.create-a-personal-connection/create%20connection%202.png)
