...
* X86 镜像：[\[下载\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.2.0-beta/obodc4.2.0-beta.tar.gz)<br>

* ARM 镜像：[\[下载\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC4.2.0-beta/obodc4.2.0-beta_arm.tar.gz)
