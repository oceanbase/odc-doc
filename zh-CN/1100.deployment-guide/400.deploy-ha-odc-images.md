...
1. 在宿主机上获得 ODC 镜像，在以下列表选择所需镜像，单击 **\[下载\]** 以获得镜像。
...
<main id="notice" type='explain'>
   ...
   <li>建议 <code>proxy_connect_timeout</code> 参数不超过 75 秒，请参见 proxy_connect_timeout：http://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_connect_timeout。</li>
