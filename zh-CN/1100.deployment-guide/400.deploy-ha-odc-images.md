...
* X86 镜像：[\[下载\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC%204.2.2-beta2/obodc4.2.2-beta2.tar.gz)<br>

* ARM 镜像：[\[下载\]](https://obodc-front.oss-cn-beijing.aliyuncs.com/ODC%204.2.2-beta2/obodc4.2.2-beta2_arm.tar.gz)
...
oceanbase/odc:test-4.2.2-20231102
```
