...
2. 项目管理员创建项目并添加项目成员。
   ...
   ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/700.database-change-management/200.project-collaborative-management/3.png)
...
3. 项目成员可以导出/导入/数据库变更/登录数据库，且项目管理员/DBA 成员支持修改所属项目。
   ...
   ![6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odc/423/700.database-change-management/200.project-collaborative-management/6.png)
