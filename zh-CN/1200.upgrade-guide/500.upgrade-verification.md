...
访问并登录 ODC 后，在连接列表页面的右上角，选择帮助中心，单击下拉列表中的 **<UI-TERM key="odc.component.GlobalHeader.AboutDeveloperCenter">关于开发者中心</UI-TERM>** 标签，在弹出的窗口中您可以获得当前应用的版本号以确定升级是否成功。更多关于 Web 版 ODC 的使用操作，请参见 ODC 用户指南（Web 版 ODC）。
