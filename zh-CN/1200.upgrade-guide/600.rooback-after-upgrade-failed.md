|slug|rooback-after-upgrade-failed|
|---|---|
...
2. 恢复升级前版本的元数据库。
    ...
    <main id="notice" type="explain">
      <h4>说明</h4>
      <ul><p>恢复使用的参数说明请参见 <a href="https://www.oceanbase.com/docs/enterprise-oceanbase-dumper-loader-cn-1000000000076572">OBLOADER 命令行选项</a>。</p></ul>
    </main>
<br>
1. 启动升级前版本的 ODC 服务。
